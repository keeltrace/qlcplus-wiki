...
`sudo apt-get install g++ make git build-essential qtbase5-dev qtscript5-dev qtmultimedia5-dev fakeroot debhelper devscripts pkg-config`<br>
...
(Fedora 21: `yum install systemd-devel fftw-devel liblo-devel`)
