...
From a Terminal, download and install [Homebrew](https://brew.sh/) like this:<br>
...
If you wish to create a distributable .dmg package, that doesn't require the presence of Qt SDK, XCode or Homebrew, type the following commands after cloning the QLC+ sources right into your terminal window:<br>
