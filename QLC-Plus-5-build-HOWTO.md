...
The environment preparation is the same explained for [Linux](https://github.com/mcallegari/qlcplus/wiki/Linux-build-(Qt6-&-cmake)), [Windows](https://github.com/mcallegari/qlcplus/wiki/Windows-Build-(Qt6-&-cmake)) and [macOS](https://github.com/mcallegari/qlcplus/wiki/macOS-build-(Qt5-and-cmake)).

On Ubuntu/Debian Linux, if not using the official Qt packages, add the following development packages:<br>

```shell
sudo apt install qt6-3d-dev qt6-3d-defaultgeometryloader-plugin qt6-3d-assimpsceneimport-plugin qml6-module-qt3d-core qml6-module-qt3d-render qml6-module-qt3d-extras qml6-module-qt3d-input qml6-module-qt3d-logic qml6-module-qtquick-scene3d qml6-module-qtmultimedia
```
