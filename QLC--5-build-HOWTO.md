...
macOS:
`export QTDIR=/Users/myuser/Qt5.9.4/5.9.4/clang_64`
`/Users/myuser/projects/Qt5.9.4/5.9.4/clang_64/bin/qmake CONFIG+=qmlui`
`make`
...
Linux:
`/home/myuser/projects/Qt5.9.4/5.9.4/gcc_64/bin/qmake CONFIG+=qmlui`
`make`
`make install` (binaries will be installed in your system. **Warning**: this will overwrite QLC+ 4)
or
`export QTDIR=/home/myuser/projects/Qt5.9.4/5.9.4/gcc_64`
